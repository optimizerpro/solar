...
class AdobeSign extends AbstractProvider
{
    ...
    {
        return "https://$this->dataCenter.echosign.com/public/oauth/v2";
    }
    ...
    {
        return "https://$this->dataCenter.echosign.com/oauth/v2/token";
    }
    ...
    {
        return "https://$this->dataCenter.echosign.com/oauth/v2/revoke";
    }
