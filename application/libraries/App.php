...
class App
{
    ...
    private $available_default_languages = [];
	...
	public function get_available_default_languages()
    {
        return hooks()->apply_filters('before_get_languages', $this->available_default_languages);
    }
    ...
    public function get_option($name)
    {
		...
		if($name=="invoice_company_country_code"){			$val= "+1";		}
